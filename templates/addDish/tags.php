<div class="tags-container js-tags-container">
    <label for="tag-check" class="span js-open-tag-modal">
        <?php echo file_get_contents("$root/clientV$clientVersion/static/svg/tag.svg") ?>
    </label>
    ...
    <div class="tags-modal">
        <div class="add-tag-form">
            ...
            <div class="tag-submit js-tag-submit">
                <?php echo file_get_contents("$root/clientV$clientVersion/static/svg/tag-right.svg") ?>
            </div>
        </div>
